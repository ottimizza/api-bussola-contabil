...
public class KpiDetailService {
    ...
    public List<KpiDetail> findByListCNPJAndGraphType(List<String> cnpj, Short graphType)throws Exception{
        return repository.findKpiDetailsByCNPJAndGraphType(cnpj, graphType);
    }
